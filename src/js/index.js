...
// Event for submiting search button
...
//Event delegation of page next & prev buttons
...
const controlRecipe = async () => {
    ...
    if(id) {
        ...
        try {
            //Get recipe data asynchronously with async-await and parseIng
 ...
 //Pobranie elementu przy zmianie hashu i przy załadowaniu strony (np przez skopiowanie linku czy odświeżenie)
...
elements.recipe.addEventListener('click', el => {
    ...
    if (el.target.matches('.btn-decrease, .btn-decrease *')) {
        ...
        //Hitting the add to shopping list button
        controlList();
